...
test2_result_list = []  # 记录测试结果


x = DATA2[4].sheet_by_name('转账测试')
DATA3 = [[x.row_values(i)[0:5] for i in range(1, x.nrows) if x.row_values(i)[0] != ''],
         DATA2[3].get_sheet('转账测试'), x, DATA2[3], DATA2[4]]
data3 = DATA3[0]
w_sheet3 = DATA3[1]
